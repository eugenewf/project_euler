 ...
 * from top to bottom is 23. <blockquote>
 * 
 * <pre>
 *    3
 *   7 4
 ...
 * </pre>
 * 
 * </blockquote> NOTE: As there are only 16384 routes, it is
 * possible to solve this problem by trying every route.
 * However, Problem 67, is the same challenge with a
 * triangle containing one-hundred rows; it cannot be solved
	...
	public static void main(String[] args) {
		int[][] triangle = {
				...
				{ 53, 71, 44, 65, 25, 43, 91, 52, 97, 51,
						14 },
				{ 70, 11, 33, 28, 77, 73, 17, 78, 39, 68,
						17, 57 },
				{ 91, 71, 52, 38, 17, 14, 91, 43, 58, 50,
						27, 29, 48 },
				{ 63, 66, 4, 68, 89, 53, 67, 30, 73, 16,
						69, 87, 40, 31 },
		...
		for (int j = 0; j < triangle[triangle.length - 1].length; j++) {
			if (triangle[triangle.length - 1][j] > max) {
