...
public class PE25 {
	public static void main(String[] args) {
		int n =3;
		BigInteger FnMinus2 = BigInteger.ONE;
		BigInteger FnMinus1 = BigInteger.ONE;
		BigInteger tenToThousand = BigInteger.valueOf(10).pow(999);
		while (true){
			BigInteger Fn = FnMinus1.add(FnMinus2);
			if (Fn.compareTo(tenToThousand)>=0){
